...
import { AdminNavigationItems } from '@/constant/nav-menu';
...
const AdminNavigation: React.FC<TAdminNavigationProps> = ({ children, onClick }) => {
  const [collapsed, setCollapsed] = useState(false);
  const [currentTab, setCurrentTab] = useState('/admin/product');
